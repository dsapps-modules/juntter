...
const iconByName = {
    ...
    'admin-estabelecimentos': <BankOutlined />,
    'vendedores-estabelecimentos': <TeamOutlined />,
    lista: <TeamOutlined />,
    faturamento: <LineChartOutlined />,
    acesso: <SafetyOutlined />,
    historico: <HistoryOutlined />,
    links: <LinkOutlined />,
    'checkout-links': <ShopOutlined />,
    'checkout-abandoned': <ShoppingCartOutlined />,
    'checkout-produtos': <ShoppingOutlined />,
    'checkout-frete': <TruckOutlined />,
    cartao: <CreditCardOutlined />,
    pix: <QrcodeOutlined />,
    boleto: <AppstoreOutlined />,
    recorrencia: <CalendarOutlined />,
    simular: <CalculatorOutlined />,
    planos: <FileDoneOutlined />,
    saldo: <WalletOutlined />,
