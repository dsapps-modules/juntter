    ...
    super_admin: [
        ...
        },
        {
            ...
            children: [
                ...
                { key: 'links-pagamento', path: '/links-pagamento', label: 'Links gerados', icon: 'links' },
    ...
    vendedor: [
        ...
        },
        {
            ...
            children: [
                ...
                { key: 'checkout.abandoned', path: '/seller/checkout-links/abandonados', label: 'Carrinho abandonado', icon: 'checkout-abandoned' },
