                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="info-item mb-2">
                                            ...
                                            <strong class="text-primary">
                                                R$
                                                {{ number_format(($transacao['original_amount'] ?? 0) / 100, 2, ',', '.') }}
                                            </strong>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="info-item mb-2">
                                                ...
                                                <strong>{{ $transacao['customer']['first_name'] ?? '' }}
                                                    {{ $transacao['customer']['last_name'] ?? '' }}</strong>
                                            </div>
                                            <div class="info-item mb-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="info-item mb-2">
                                                ...
                                                <strong
                                                    class="font-monospace">{{ $transacao['acquirer']['gateway_key'] ?? 'N/A' }}</strong>
                                            </div>
                                            <div class="info-item mb-2">
                                    ...
                                    <div class="info-item mb-2">
                                        ...
                                        <div class="input-group no-wrap">
                                            <input type="text" class="form-control font-monospace"
                                                value="{{ $transacao['emv'] }}" readonly>
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-secondary" type="button"
                                                    data-value="{{ $transacao['emv'] }}" onclick="copyToClipboard(this)">
                                                ...
                                                @foreach($transacao['expected_on'] as $parcela)
                                                    <tr>
                                                        ...
                                                        <td class="text-success">
                                                            <strong>R$
                                                                {{ number_format($parcela['amount'] / 100, 2, ',', '.') }}</strong>
                                                        </td>
                                                        <td>
                                            ...
                                            <div class="col-md-6">
                                                <div class="info-item mb-2">
                                                    ...
                                                    <strong>
                                                        ...
                                                        @else
                                                            <span
                                                                class="badge badge-secondary">{{ $antifraud['analyse_status'] }}</span>
                                                        @endif
                                                    </strong>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="info-item mb-2">
                                                ...
                                                <strong>
                                                    ...
                                                    @else
                                                        <span
                                                            class="badge badge-secondary">{{ $transacao['point_of_sale']['type'] }}</span>
                                                    @endif
                                                </strong>
                                            </div>
                                        </div>
