            ...
            <div class="form-section">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-4">
                        ...
                        <div id="cardBrandPreview" class="card-brand-preview" aria-label="Bandeira do cart�o" aria-live="polite"></div>
                    </div>
                </div>
                    ...
                    <div class="row mt-1">
                        <div class="col-md-6 mb-4">
                            ...
                            <select name="installments" class="form-select" id="installmentsSelect" required disabled>
                                <option value="">Digite o n�mero do cart�o para carregar as parcelas</option>
                            </select>
                        </div>
                    </div>
                @endif
