                        ...
                        <tbody>
                            @foreach ($estabelecimentos['data'] ?? [] as $estabelecimento)
                                <tr>
                                    ...
                                    <td><span class="text-muted">{{ $estabelecimento['phone_number'] ?? 'N/A' }}</span>
                                    </td>
                                    <td><span
                                            class="text-muted">{{ $estabelecimento['address']['city'] ?? 'N/A' }}/{{ $estabelecimento['address']['state'] ?? 'N/A' }}</span>
                                    </td>
                                    <td>
                                        @if (isset($estabelecimento['status']))
                                            ...
                                            @else
                                                <span
                                                    class="badge badge-secondary">{{ $estabelecimento['status'] }}</span>
                                            @endif
                                        @else
                                    ...
                                    <td>
                                        @if (isset($estabelecimento['risk']))
                                            ...
                                            @else
                                                <span
                                                    class="badge badge-secondary">{{ $estabelecimento['risk'] }}</span>
                                            @endif
                                        @else
                                            <span class="badge badge-secondary">N/A</span>
                                        @endif
