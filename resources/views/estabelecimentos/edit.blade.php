            ...
            <div class="card border-0 shadow-lg rounded-4">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h3 class="h4 mb-1 fw-bold">Editar {{ $estabelecimento['first_name'] ?? 'Estabelecimento' }}
                            </h3>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="access_type"
                                        class="form-select @error('access_type') is-invalid @enderror" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="format" class="form-select @error('format') is-invalid @enderror"
                                        ...
                                        <option value="EIRELI" {{ (old('format', $estabelecimento['format'] ?? '') == 'EIRELI') ? 'selected' : '' }}>EIRELI - Empresa Individual de
                                            Responsabilidade Limitada</option>
