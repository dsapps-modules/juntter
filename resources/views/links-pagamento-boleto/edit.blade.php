...
@section('title', 'Editar Link de Pagamento - Boleto')
    ...
    <div class="col-12">
        <div class="card border-0 shadow-lg rounded-4">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h3 class="h4 mb-1 fw-bold">
                            ...
                            Editar Link de Pagamento Boleto
                        </h3>
                        <p class="text-muted mb-0">Atualize as configurações do seu link de pagamento boleto</p>
                    </div>
                    <div>
                        <a href="{{ route('links-pagamento-boleto.show', $linkPagamento->id) }}" class="btn btn-info mr-2">
                ...
                <form action="{{ route('links-pagamento-boleto.update', $linkPagamento->id) }}" method="POST" id="formLinkPagamentoBoleto">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    id="valor"
                                    name="valor"
                                    value="{{ old('valor', 'R$ ' . number_format($linkPagamento->valor, 2, ',', '.')) }}"
                                    placeholder="0,00"
                                    required>
                                @error('valor')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ old('data_vencimento', $linkPagamento->data_vencimento ? $linkPagamento->data_vencimento->format('Y-m-d') : '') }}"
                                    min="{{ date('Y-m-d', strtotime('+1 day')) }}"
                                    required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ old('data_limite_pagamento', $linkPagamento->data_limite_pagamento ? $linkPagamento->data_limite_pagamento->format('Y-m-d') : '') }}"
                                    min="{{ date('Y-m-d', strtotime('+1 day')) }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('instrucoes_boleto.description', $linkPagamento->instrucoes_boleto['description'] ?? '') }}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ old('instrucoes_boleto.discount.limit_date', $linkPagamento->instrucoes_boleto['discount']['limit_date'] ?? '') }}"
                                    required>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group no-wrap">
                                    <input type="text"
                                        ...
                                        value="{{ old('instrucoes_boleto.late_fee.amount', $linkPagamento->instrucoes_boleto['late_fee']['amount'] ?? '') }}"
                                        placeholder="2,00"
                                        required>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group no-wrap">
                                    <input type="text"
                                        ...
                                        value="{{ old('instrucoes_boleto.interest.amount', $linkPagamento->instrucoes_boleto['interest']['amount'] ?? '') }}"
                                        placeholder="1,00"
                                        required>
                                    <span class="input-group-text"><i class="fas fa-percentage"></i></span>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group no-wrap">
                                    <input type="text"
                                        ...
                                        value="{{ old('instrucoes_boleto.discount.amount', $linkPagamento->instrucoes_boleto['discount']['amount'] ?? '') }}"
                                        placeholder="5,00"
                                        required>
                                    <span class="input-group-text"><i class="fas fa-percentage"></i></span>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('dados_cliente_preenchidos.nome', $dadosCliente['nome'] ?? '') }}"
                                        placeholder="Nome"
                                        required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('dados_cliente_preenchidos.sobrenome', $dadosCliente['sobrenome'] ?? '') }}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('dados_cliente_preenchidos.documento', $dadosCliente['documento'] ?? '') }}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="email"
                                    ...
                                    value="{{ old('dados_cliente_preenchidos.email', $dadosCliente['email'] ?? '') }}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('dados_cliente_preenchidos.telefone', $dadosCliente['telefone'] ?? '') }}"
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('dados_cliente_preenchidos.endereco.rua', $endereco['rua'] ?? '') }}"
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('dados_cliente_preenchidos.endereco.numero', $endereco['numero'] ?? '') }}"
                                    placeholder="123"
                                    required>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('dados_cliente_preenchidos.endereco.complemento', $endereco['complemento'] ?? '') }}"
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('dados_cliente_preenchidos.endereco.bairro', $endereco['bairro'] ?? '') }}"
                                    placeholder="Centro"
                                    required>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('dados_cliente_preenchidos.endereco.cep', $endereco['cep'] ?? '') }}"
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('dados_cliente_preenchidos.endereco.cidade', $endereco['cidade'] ?? '') }}"
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('dados_cliente_preenchidos.endereco.estado') is-invalid @enderror" id="estado" name="dados_cliente_preenchidos[endereco][estado]" required>
                                    <option value="">Selecione...</option>
                                    <option value="AC" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'AC' ? 'selected' : '' }}>Acre</option>
                                    <option value="AL" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'AL' ? 'selected' : '' }}>Alagoas</option>
                                    <option value="AP" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'AP' ? 'selected' : '' }}>Amapá</option>
                                    <option value="AM" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'AM' ? 'selected' : '' }}>Amazonas</option>
                                    <option value="BA" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'BA' ? 'selected' : '' }}>Bahia</option>
                                    <option value="CE" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'CE' ? 'selected' : '' }}>Ceará</option>
                                    <option value="DF" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'DF' ? 'selected' : '' }}>Distrito Federal</option>
                                    <option value="ES" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'ES' ? 'selected' : '' }}>Espírito Santo</option>
                                    <option value="GO" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'GO' ? 'selected' : '' }}>Goiás</option>
                                    <option value="MA" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'MA' ? 'selected' : '' }}>Maranhão</option>
                                    <option value="MT" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'MT' ? 'selected' : '' }}>Mato Grosso</option>
                                    <option value="MS" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'MS' ? 'selected' : '' }}>Mato Grosso do Sul</option>
                                    <option value="MG" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'MG' ? 'selected' : '' }}>Minas Gerais</option>
                                    <option value="PA" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'PA' ? 'selected' : '' }}>Pará</option>
                                    <option value="PB" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'PB' ? 'selected' : '' }}>Paraíba</option>
                                    <option value="PR" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'PR' ? 'selected' : '' }}>Paraná</option>
                                    <option value="PE" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'PE' ? 'selected' : '' }}>Pernambuco</option>
                                    <option value="PI" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'PI' ? 'selected' : '' }}>Piauí</option>
                                    <option value="RJ" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'RJ' ? 'selected' : '' }}>Rio de Janeiro</option>
                                    <option value="RN" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'RN' ? 'selected' : '' }}>Rio Grande do Norte</option>
                                    <option value="RS" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'RS' ? 'selected' : '' }}>Rio Grande do Sul</option>
                                    <option value="RO" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'RO' ? 'selected' : '' }}>Rondônia</option>
                                    <option value="RR" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'RR' ? 'selected' : '' }}>Roraima</option>
                                    <option value="SC" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'SC' ? 'selected' : '' }}>Santa Catarina</option>
                                    <option value="SP" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'SP' ? 'selected' : '' }}>São Paulo</option>
                                    <option value="SE" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'SE' ? 'selected' : '' }}>Sergipe</option>
                                    <option value="TO" {{ old('dados_cliente_preenchidos.endereco.estado', $endereco['estado'] ?? '') == 'TO' ? 'selected' : '' }}>Tocantins</option>
                                </select>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('links-pagamento-boleto.show', $linkPagamento->id) }}" class="btn btn-secondary">
                                    <i class="fas fa-times mr-2"></i>Cancelar
                                </a>
                                <button type="submit" class="btn btn-primary ml-2">
                                    <i class="fas fa-save mr-2"></i>Atualizar Link Boleto
                                </button>
                            </div>
                        </div>
                    </div>
