...
@section('title', 'Editar Link de Pagamento PIX')
    ...
    <div class="col-12">
        <div class="card border-0 shadow-lg rounded-4">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h3 class="h4 mb-1 fw-bold">
                            ...
                            Editar Link de Pagamento PIX
                        </h3>
                        <p class="text-muted mb-0">Atualize as configurações do seu link de pagamento PIX</p>
                    </div>
                    <div>
                        <a href="{{ route('links-pagamento-pix.show', $linkPagamento->id) }}" class="btn btn-info mr-2">
                ...
                <form action="{{ route('links-pagamento-pix.update', $linkPagamento->id) }}" method="POST" id="formLinkPagamentoPix">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('links-pagamento-pix.show', $linkPagamento->id) }}" class="btn btn-secondary">
                                    <i class="fas fa-times mr-2"></i>Cancelar
                                </a>
                                <button type="submit" class="btn btn-primary ml-2">
                                    <i class="fas fa-save mr-2"></i>Atualizar Link PIX
                                </button>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    // Definir estado inicial do switch baseado nos dados existentes
