...
@section('title', 'Detalhes do Link de Pagamento PIX')
...
/>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex">
                    <a href="{{ route('links-pagamento-pix.edit', $linkPagamento->id) }}" class="btn btn-warning mr-2">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Tem certeza que deseja excluir o link "<strong>{{ $linkPagamento->descricao ?: 'Sem descrição' }}</strong>"?</p>
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('links-pagamento-pix.destroy', $linkPagamento->id) }}" method="POST" style="display: inline;">
                    @csrf
                    @method('DELETE')
...
function alterarStatus(novoStatus) {
    ...
    fetch(`/links-pagamento-pix/{{ $linkPagamento->id }}/status`, {
        method: 'PATCH',
        headers: {
