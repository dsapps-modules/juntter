...
@section('content')
    <!-- Breadcrumb -->
    <x-breadcrumb :items="[['label' => 'Links de Pagamento', 'icon' => 'fas fa-link', 'url' => route('links-pagamento.index')]]" />
                                    ...
                                    @foreach ($links as $link)
                                        <tr>
                                            ...
                                            <td data-order="{{ $link->created_at->format('Y-m-d H:i:s') }}">
                                                <small
                                                    class="text-muted">{{ $link->created_at->format('d/m/Y H:i') }}</small>
                                            </td>
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-secondary toggle-status"
                                                        ...
                                                        data-current-status="{{ $link->status }}" title="Alterar Status">
                                                        <i class="fas fa-toggle-on"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-danger delete-link"
                                                        data-link-id="{{ $link->id }}" title="Excluir">
