                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <p class="mb-0">
                                            <span class="badge badge-success"
                                                style="font-size: 1rem;">{{ $linkPagamento->valor_formatado }}</span>
                                        </p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <p class="mb-0">
                                            <code
                                                class="bg-light px-2 py-1 rounded">{{ $linkPagamento->codigo_unico }}</code>
                                        </p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="input-group no-wrap mb-3">
                                    <input type="text" class="form-control" id="linkInput"
                                        value="{{ $linkPagamento->url_completa }}" readonly>
                                ...
                                <div class="d-flex flex-wrap">
                                    <a href="{{ $linkPagamento->url_completa }}" target="_blank"
                            ...
                            <div class="card-body d-flex flex-column justify-content-between">
                                <div class="row">
                                    @if (isset($linkPagamento->dados_cliente['preenchidos']['nome']))
                                        <div class="col-md-3 mb-3">
                                            <div class="d-flex align-items-center">
                                                <i class="fas fa-user text-primary mr-3"
                                                    style="font-size: 1rem; width: 20px;"></i>
                                                        ...
                                                        @if (isset($linkPagamento->dados_cliente['preenchidos']['nome']) && $linkPagamento->dados_cliente['preenchidos']['nome'])
                                                            <div class="mt-1">
                                                                <small class="text-success"><i
                                                                        class="fas fa-check-circle"></i> Pré-preenchido:
                                                                    {{ $linkPagamento->dados_cliente['preenchidos']['nome'] }}</small>
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div>
                                                        ...
                                                        @if (isset($linkPagamento->dados_cliente['preenchidos']['sobrenome']) &&
                                                                $linkPagamento->dados_cliente['preenchidos']['sobrenome']
                                                        )
                                                            <div class="mt-1">
                                                                <small class="text-success"><i
                                                                        class="fas fa-check-circle"></i> Pré-preenchido:
                                                                    {{ $linkPagamento->dados_cliente['preenchidos']['sobrenome'] }}</small>
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
                                    ...
                                    @if (isset($linkPagamento->dados_cliente['preenchidos']['email']))
                                        <div class="col-md-6 mb-3">
                                            <div class="d-flex align-items-center">
                                                <i class="fas fa-envelope text-primary mr-3"
                                                    style="font-size: 1rem; width: 20px;"></i>
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div>
                                                        ...
                                                        @if (isset($linkPagamento->dados_cliente['preenchidos']['email']) &&
                                                                $linkPagamento->dados_cliente['preenchidos']['email']
                                                        )
                                                            <div class="mt-1">
                                                                <small class="text-success"><i
                                                                        class="fas fa-check-circle"></i> Pré-preenchido:
                                                                    {{ $linkPagamento->dados_cliente['preenchidos']['email'] }}</small>
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
                                    ...
                                    @if (isset($linkPagamento->dados_cliente['preenchidos']['telefone']))
                                        <div class="col-md-6 mb-3">
                                            <div class="d-flex align-items-center">
                                                <i class="fas fa-phone text-primary mr-3"
                                                    style="font-size: 1rem; width: 20px;"></i>
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div>
                                                        ...
                                                        @if (isset($linkPagamento->dados_cliente['preenchidos']['telefone']) &&
                                                                $linkPagamento->dados_cliente['preenchidos']['telefone']
                                                        )
                                                            <div class="mt-1">
                                                                <small class="text-success"><i
                                                                        class="fas fa-check-circle"></i> Pré-preenchido:
                                                                    {{ $linkPagamento->dados_cliente['preenchidos']['telefone'] }}</small>
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
                                    ...
                                    @if (isset($linkPagamento->dados_cliente['preenchidos']['documento']))
                                        <div class="col-md-6 mb-3">
                                            <div class="d-flex align-items-center">
                                                <i class="fas fa-id-card text-primary mr-3"
                                                    style="font-size: 1rem; width: 20px;"></i>
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div>
                                                        ...
                                                        @if (isset($linkPagamento->dados_cliente['preenchidos']['documento']) &&
                                                                $linkPagamento->dados_cliente['preenchidos']['documento']
                                                        )
                                                            <div class="mt-1">
                                                                <small class="text-success"><i
                                                                        class="fas fa-check-circle"></i> Pré-preenchido:
                                                                    {{ $linkPagamento->dados_cliente['preenchidos']['documento'] }}</small>
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
                                    ...
                                    @endif
                                    @if (isset($linkPagamento->dados_cliente['preenchidos']['endereco']) &&
                                            is_array($linkPagamento->dados_cliente['preenchidos']['endereco']))
                                        <div class="col-md-12 mb-3">
                                            <div class="d-flex align-items-center">
                                                <i class="fas fa-map-marker-alt text-primary mr-3"
                                                    style="font-size: 1rem; width: 20px;"></i>
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div>
                                                        ...
                                                        @if (isset($linkPagamento->dados_cliente['preenchidos']['endereco']) &&
                                                            ...
                                                            @php
                                                                $endereco =
                                                                    $linkPagamento->dados_cliente['preenchidos'][
                                                                        'endereco'
                                                                    ];
                                                                $enderecoCompleto = [];
                                                            ...
                                                            @if (!empty($enderecoCompleto))
                                                                <div class="mt-1">
                                                                    <small class="text-success"><i
                                                                        ...
                                                                        Pré-preenchido:
                                                                        {{ implode(', ', $enderecoCompleto) }}</small>
                                                                </div>
                                                            @endif
                                                        @endif
                                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        @if ($linkPagamento->url_retorno)
                                            <a href="{{ $linkPagamento->url_retorno }}" target="_blank"
                                                class="d-block text-break small">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        @if ($linkPagamento->url_webhook)
                                            <a href="{{ $linkPagamento->url_webhook }}" target="_blank"
                                                class="d-block text-break small">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('links-pagamento.destroy', $linkPagamento->id) }}" method="POST"
