                                        ...
                                        <div class="form-section">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-4">
                                                    <label class="form-label">Nome do titular <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" name="card[holder_name]"
                                                        class="form-control" placeholder="Nome completo" required>
                                                </div>
                                                <div class="col-md-6 mb-4">
                                                    <label class="form-label">Número do cartão <span
                                                            class="text-danger">*</span></label>
                                                    <div class="form-group">
                                                        <input type="text" name="card[card_number]"
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 mb-4">
                                                    <label class="form-label">Mês <span
                                                            class="text-danger">*</span></label>
                                                    <select name="card[expiration_month]" class="form-select"
                                                        required>
                                                ...
                                                <div class="col-md-3 mb-4">
                                                    <label class="form-label">Ano <span
                                                            class="text-danger">*</span></label>
                                                ...
                                                <div class="col-md-3 mb-4">
                                                    <label class="form-label">CVV <span
                                                            class="text-danger">*</span></label>
                                                    <div class="form-group">
                                                        <input type="text" name="card[security_code]"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-4">
                                                        <label class="form-label">Nome <span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" name="client[first_name]"
                                                            class="form-control" placeholder="Nome completo"
                                                            value="{{ $link->dados_cliente['preenchidos']['nome'] ?? '' }}"
                                                            required>
                                                    </div>
                                                    <div class="col-md-6 mb-4">
                                                        ...
                                                        <input type="text" name="client[last_name]"
                                                            ...
                                                            value="{{ $link->dados_cliente['preenchidos']['sobrenome'] ?? '' }}"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6 mb-4">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="email" name="client[email]"
                                                                ...
                                                                value="{{ $link->dados_cliente['preenchidos']['email'] ?? '' }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-4">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" name="client[phone]"
                                                                ...
                                                                value="{{ $link->dados_cliente['preenchidos']['telefone'] ?? '' }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12 mb-4">
                                                        <label class="form-label">CPF/CNPJ <span
                                                                class="text-danger">*</span></label>
                                                        <div class="form-group">
                                                            <input type="text" name="client[document]"
                                                                class="form-control" placeholder="000.000.000-00"
                                                                value="{{ $link->dados_cliente['preenchidos']['documento'] ?? '' }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
