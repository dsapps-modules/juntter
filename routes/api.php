...
Route::post('/webhook/paytime/transaction-state-changed', [PaytimeWebhookController::class, 'transactionStateChanged']);
...
Route::post('/webhook/paytime/test', [PaytimeWebhookController::class, 'testWebhook']);