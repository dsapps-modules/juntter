...
class PublicCheckoutSpaTest extends TestCase
{
    ...
    public function test_checkout_spa_source_includes_the_3ds_flow(): void
    {
        ...
        $this->assertStringContainsString('.checkout-spa-theme--essential .checkout-spa-identification-fields--pf > .checkout-spa-field:has([name="customer_document"]) {', $styles);
        $this->assertStringContainsString('order: 2;', $styles);
        $this->assertStringContainsString('.checkout-spa-theme--essential .checkout-spa-identification-fields--pf > .checkout-spa-field:has([name="customer_birth_date"]) {', $styles);
        $this->assertStringContainsString('order: 3;', $styles);
        ...
        $this->assertMatchesRegularExpression('/@media \(max-width: 640px\) \{[\s\S]*?\.checkout-spa-theme--essential \.checkout-spa-delivery-fields > \.checkout-spa-field:has\(\[name="zipcode"\]\) \{[\s\S]*?order: 1;[\s\S]*?\.checkout-spa-theme--essential \.checkout-spa-delivery-fields > \.checkout-spa-field:has\(\[name="street"\]\) \{[\s\S]*?order: 2;[\s\S]*?\.checkout-spa-theme--essential \.checkout-spa-delivery-fields > \.checkout-spa-field:has\(\[name="number"\]\) \{[\s\S]*?order: 3;[\s\S]*?\.checkout-spa-theme--essential \.checkout-spa-delivery-fields > \.checkout-spa-field:has\(\[name="complement"\]\) \{[\s\S]*?order: 4;/', $styles);
