[x] o título do de exportação do excel, na conta do vendedor, deve ser 'Exportar transações'
[x] acessar conta bancária: levava para perfil
[x] bloquear edição de informações de perfil: feito
[x] destacar mouseover no botão 'Link de pagamento'
[x] página de pagamento: centralizar pills??? Já não tinha removido?
[x] seletor de data na página de saldo e extrato do vendedor
[x] atualização de estabelecimentos está só até 30/03???
